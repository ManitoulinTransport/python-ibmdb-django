...
class DatabaseCreation ( BaseDatabaseCreation ):
    ...
    def create_test_db( self, verbosity = 0, autoclobber = False , keepdb=False,serialize=False):
        ...
        # TODO: READ THE TEST SCHEMA from django settings
        self.connection.cursor().execute('set schema test')

        return test_database

    # Method to destroy database. For Jython nothing is getting done over here.
    def destroy_test_db( self, old_database_name, verbosity = 0, *args ):
        print('Destroy test DB: doing nothing')
